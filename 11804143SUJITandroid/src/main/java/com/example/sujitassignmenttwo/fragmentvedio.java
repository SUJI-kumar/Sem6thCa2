...
public class fragmentvedio extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View rootview=inflater.inflate(R.layout.activity_fragmentvedio,container,false);
        v=rootview.findViewById(R.id.v1);
        MediaController m=new MediaController(getActivity());
        String videopath="android.resource://"+getActivity().getPackageName()+"/"+R.raw.screen;
